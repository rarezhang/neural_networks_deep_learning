...
class Network(object):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta,
        ...
        for j in range(epochs):
            ...
            for mini_batch in mini_batches:
                self.update_mini_batch(mini_batch, eta)  # updates the network weights and biases according to a single iteration of gradient descent, using just the training data in mini_batch.
            if test_data:
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        for x, y in mini_batch:
            delta_nabla_b, delta_nabla_w = self.backprop(x, y)  # invokes the backpropagation algorithm -> fast way of computing the gradient of the cost function
